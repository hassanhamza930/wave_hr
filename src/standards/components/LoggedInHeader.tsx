...
export default function LoggedInHeader() {
    ...
    return (
        <div className="fixed shadow-md shadow-black/10 h-[70px] bg-tan z-50 w-full flex flex-row justify-between items-center px-[5%] py-5">
            ...
            <div className="flex flex-row gap-16 justify-between items-center">
                ...
                <Menu >
                    <Menu.Button onClick={() => { }} className="flex flex-row justify-center items-center gap-2 border-2 p-2 rounded-xl hover:border-blue border-gray">
