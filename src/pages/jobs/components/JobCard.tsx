...
export default function JobCard(props:JobData) {
    ...
    return (
        <button onClick={()=>{setSelectedJob(props)}} className="w-full border-2 rounded-xl hover:bg-breen hover:text-white border-breen flex flex-col justify-start text-left items-start p-4">            
