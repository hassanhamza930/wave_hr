...
export default function JobCard(props:JobData) {
    ...
    return (
        <button onClick={()=>{setSelectedJob(props)}} className=" text-left w-full border-2 rounded-xl hover:bg-breen hover:text-white border-breen flex flex-col justify-start items-start p-4">            
