...
function PricingCard(props: PricingCardProps) {
    return (
        <div className={`border-2 ${props.bray == true ? "border-bray/80" : "border-breen"} hover:border-breen text-breen hover:text-white flex flex-col justify-start items-start gap-1 p-5 w-[90%] ${props.bray == true ? "text-bray/80" : "text-breen"} hover:bg-breen rounded-xl`}>
...
function EarlyAccessPricingCard(props: PricingCardProps) {
    ...
    return (
        ...
        }} className={`h-48 hover:border-2 ${props.bray == true ? "border-bray/80" : "border-[#F96666]"} hover:border-breen text-breen hover:text-white flex flex-col justify-start text-start items-start gap-1 p-5 w-[90%] ${props.bray == true ? "text-bray/80" : "text-[#F96666]"} hover:bg-breen bg-transparent border-2 border-[#F96666] rounded-xl`}>
