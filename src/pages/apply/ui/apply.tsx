    ...
    return (
        <>
            ...
            <div className="h-screen w-full bg-breen flex justify-center items-center">
                ...
                <div className="pb-20 text-breen w-[70%] rounded-md h-[90%] overflow-y-scroll flex-col justify-start items-start">
                        ...
                        <div className="flex flex-col justify-start items-start">
                            <div className="flex flex-row justify-start items-start gap-2 mt-10">
                                ...
                                <div className="flex w-full flex-col justify-start items-start">
                                    ...
                                    <div className="text-white/80 w-96 text-md">{companyData.companyDescription}</div>
                                </div>
                            </div>
