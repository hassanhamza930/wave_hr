...
export default function Page1() {
    ...
    function handlePage1DataSubmit(data: JobApplication) {
        ...
        if (watch("name") == "" || watch("email") == "" || selectedProfilePicture == "") {
    ...
    return (
        <form onSubmit={handleSubmit(handlePage1DataSubmit)} className="h-full w-full rounded-md overflow-y-scroll justify-start items-start flex-col p-10">
            ...
            <input {...register("name")} placeholder="Full Name" className="mt-10 w-96 border-b-[1px] border-white/90 text-white/90 bg-transparent outline-0 px-2 py-1 flex justify-center items-center">
            </input>
