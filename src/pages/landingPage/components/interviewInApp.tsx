...
export default function InterviewInApp() {
    return (
        <div className="h-min w-full px-[15%] py-24 flex flex-col justify-start items-start">
            <div className="text-breen text-7xl font-bold">Interview in App</div>
            <div className="text-breen text-4xl font-bold">Never loose context</div>

            <div className="text-breen text-xl font-regular mt-10">
            ...
            <div className="flex flex-row justify-start items-start gap-5 my-10">
                    ...
                    <div className="h-72 w-96 rounded-xl bg-cover bg-center flex flex-col justify-between items-between">
                        <div className="h-[77%] w-full bg-breen rounded-xl flex justify-start items-start p-5 text-white  flex-col">
                        ...
                        <div className="h-[20%] w-full flex flex-row gap-5 justify-start items-center px-2 py-2 text-white font-bold text-2xl">
                            <button className="bg-breen w-12 rounded-md h-full flex justify-center items-center"> - </button>
                            <div className="bg-breen w-12 rounded-md h-full flex justify-center items-center">9</div>
                            <button className="bg-breen w-12 rounded-md h-full flex justify-center items-center">+</button>
                        </div>
