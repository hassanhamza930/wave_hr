...
export default function WeBelieveEveryApplicationDeservesToBeSeen() {
    return (
        <div className="h-min w-full flex justify-start items-start px-[15%] py-24 flex flex-col justify-start items-start">
            <div className="text-breen text-7xl font-bold">We believe</div>
            <div className="text-breen text-4xl font-bold">Every application deserves to be seen!</div>
            ...
            <div className="text-breen text-xl font-regular mt-5">
                Here’s how we make hiring a breeze for you.
            </div>

            <div className="h-12 w-12 mt-10 bg-breen rounded-md flex justify-center items-center">
